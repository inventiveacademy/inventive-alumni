...
code is useful since it's unlikely to chanfe as often as the
application's code. So all the libraries we refernce here
...
referenced here will be bundled into main.js for the production
build. */
